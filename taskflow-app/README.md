...
- **[Nœuds du cluster](preuves/partie-3/get-nodes.png)** - Cluster kind avec 3 nœuds
- **[Pods déployés](preuves/partie-3/get-pods.png)** - Tous les services en Running
- **[StatefulSet PostgreSQL](preuves/partie-3/statefulset-pvc.png)** - StatefulSet avec PVC stable
- **[Frontend accessible](preuves/partie-3/app-running-front.png)** - Interface TaskFlow via Ingress
